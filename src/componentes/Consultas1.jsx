...
export default function Consultas1(props) {
  ...
  const [valoresDefault, setValoresDefault] = useState(props.valoresIniciales)
        ...
        <div className="col-12">
          ...
          <h1 className="header-1">Agregar consulta</h1><hr/>
            <div className="row">
              ...
              <div className="form-group col-sm-6 ">
                ...
                <select className="custom-select" key="idsolicitante" defaultValue={props.valoresIniciales.id_solicitante} onChange={handlerSeleccion} name="id_solicitante" ref={register({required: true})}>
            ...
            {solicitante === 5 && 
              <div className="row">
                <div className="form-group col-sm-12">
                  ...
                  <input className="form-control" type="text" placeholder="Escriba el otro tipo de solicitante" id="solicitante_otro" name="solicitante_otro" defaultValue={props.valoresIniciales.solicitante_otro} ref={register({required: true})} />
            ...
            <div className="row">
              <div className="form-group col-sm-12">
                ...
                <input className="form-control" type="text" id="tema" name="tema" defaultValue={props.valoresIniciales.tema} ref={register({required: true})} />
          ...
          <div className="row">
            <div className="form-group col-sm-12 ">
              ...
              <select className="custom-select" key="id_respuesta" defaultValue={props.valoresIniciales.id_respuesta} onChange={handlerSeleccion} name="id_respuesta" ref={register}>
          ...
          <div className="row">
            <div className="form-group col-sm-12">
              ...
              <input  type="date" className="form-control" id="fecha_respuesta" name="fecha_respuesta"defaultValue={props.valoresIniciales.fecha_respuesta} placeholder="Digite la fecha" ref={register} />
