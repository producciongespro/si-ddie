              ...
              <div className="textos control-group form-group mt-2">
                ...
                <div className="row">
                    <div className="col-12">
                        <TextInput key="contraseña" type="password" className="form-control input-ingreso" placeholder="Digite la contraseña" id="claveEncriptada" name="claveEncriptada" required value="a" />
                    </div>
                </div>
                <br/>
              </div>
